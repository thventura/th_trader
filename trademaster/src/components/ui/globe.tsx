...
const Globe: React.FC = () => {
  return (
    <>
      ...
      <div className="flex items-center justify-center pt-10 pb-10 md:pt-20 md:pb-20">
        {/* Usando transform: scale() para aumentar visualmente o globo sem quebrar as sombras (box-shadow) 
            e as posições de background que foram configuradas pelo usuário para um container de 250px. 
            Tamanho levemente reduzido a pedido do usuário. */}
        <div className="scale-[1.25] sm:scale-[1.5] md:scale-[1.75] lg:scale-[2] origin-center mt-8 md:mt-0 transition-transform duration-500 ease-in-out">
          <div
