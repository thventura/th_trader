          ...
          <div className={cn('rounded-xl border overflow-hidden p-6', isDark ? 'border-slate-700 bg-slate-900' : 'border-gray-300 bg-gray-950')}>
            ...
            <ResponsiveContainer width="100%" height={280}>
              <AreaChart data={dadosGrafico} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                ...
                />
                <Area type="monotone" dataKey="banca" stroke="#3b82f6" strokeWidth={2.5} fill="url(#gradBanca2x1)" dot={{ r: 4, fill: '#3b82f6', strokeWidth: 0 }} activeDot={{ r: 6, fill: '#3b82f6', stroke: '#fff', strokeWidth: 2 }} />
              </AreaChart>
            </ResponsiveContainer>
